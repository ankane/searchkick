...
module Searchkick
  ...
  class << self
    attr_accessor :search_method_name, :wordnet_path, :timeout, :models, :client_options, :refresh_wait_for, :redis, :index_prefix, :index_suffix, :queue_name, :model_options
