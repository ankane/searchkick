...
class BoostTest < Minitest::Test
  ...
  def test_boost_by_distance_v2_factor
    store [
      {name: "San Francisco", latitude: 37.7833, longitude: -122.4167, population: 864816},
      {name: "San Antonio", latitude: 29.4167, longitude: -98.5000}, population: 1493000,
      {name: "San Marino", latitude: 43.9333, longitude: 12.4667, population: 33203}
    ]
    assert_order "san", ["San Francisco", "San Antonio", "San Marino"], boost_by: {population: {factor: 10}, boost_by_distance: {location: {origin: [37, -122], scale: "1000mi", factor: 100}}
  end
